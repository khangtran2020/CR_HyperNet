...
def add_defense_group(group):
    ...
    group.add_argument('--num_draws_udp', type=int, default=100, help="number of draws for userdp robustness bound")
    group.add_argument('--num_draws_ldp', type=float, default=100, help="number of draws for LDP robustness bound")
